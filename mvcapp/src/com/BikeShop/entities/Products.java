...
public class Products {
	...
	public Products(String pName, String pImage, String pDescription, int pQuantity, Double pPrice, String pOption) {
		super();
		this.pName = pName;
		this.pImage = pImage;
	...
	public Products(int pId, String pName, String pImage, String pDescription, int pQuantity, Double pPrice,
			String pOption) {
		super();
		this.pId = pId;
		this.pName = pName;
