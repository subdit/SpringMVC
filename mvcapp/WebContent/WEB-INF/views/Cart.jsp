...
<%-- <a class="btn btn-secondary" href="${pageContext.request.contextPath}/removeProduct/${item.pId}" role="button">Remove Item</a> --%>
		...
		<a class="nav-link" href="${pageContext.request.contextPath}/allproducts">Continue Shopping</a><br><br>
		
		<a class="nav-link" href="${pageContext.request.contextPath}/checkoutPage">Check Out</a>
					<hr>
</body>
</html>